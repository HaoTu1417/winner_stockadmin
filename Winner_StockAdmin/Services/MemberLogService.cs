...
// Type: DB.Services.MemberLogService
...
namespace DB.Services
{
  public class MemberLogService
  {
    public static MemberLogDto Find(int pk)
    {
      ...
      try
      {
        using (MySqlConnection readConnection = DapperMysql.GetReadConnection())
        {
          ...
          return readConnection.QueryFirstOrDefault<MemberLogDto>(sql, (object) parameters);
        }
      }
      catch (Exception ex)
      {
        LogLib.Log("[MemberLogService][Find]" + ex.Message);
        return (MemberLogDto) null;
      }
    }
    ...
    public static List<MemberLogDto> FindAll()
    {
      ...
      {
        using (MySqlConnection readConnection = DapperMysql.GetReadConnection())
          return readConnection.Query<MemberLogDto>(sql).AsList<MemberLogDto>();
      }
      catch (Exception ex)
      {
        LogLib.Log("[MemberLogService][FindAll]" + ex.Message);
        return (List<MemberLogDto>) null;
      }
    }
